...
# GA2_3("""Publish a page using GitHub Pages that showcases your work. Ensure that your email address 23f3001764@ds.study.iitm.ac.in is in the page's HTML.
...
# GA2_7("""Create a GitHub action on one of your GitHub repositories. Make sure one of the steps in the action has a name that contains your email address 23f3001764@ds.study.iitm.ac.in. For example:
